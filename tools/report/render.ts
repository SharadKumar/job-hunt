/**
 * Profile report renderer: every panel, card and tab the report is made of,
 * plus the page shell that fills the HTML template.
 *
 * Takes a model from `model.ts`, escapes and highlights through
 * `highlight.ts`, and returns a finished page.
 */
