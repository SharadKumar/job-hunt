...
- Today viewport pass: passed. Needs you and Sent overnight are peer tabs on the title row, with the brief retained above one active workspace. At 1300 by 1204 the page height and viewport height both measured 1204 pixels, the page header began at 80 pixels like Resumes and Schedules, and both Needs you panes scroll internally. Sent overnight uses the same bordered workspace rather than a second section below it.
