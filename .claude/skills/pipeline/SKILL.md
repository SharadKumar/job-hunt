...
1. `npm run pipeline -- summary` for totals by status.
...
3. **Audit recap**: `npm run audit:summary -- --days 7` for submissions in the last week, distinct companies contacted, top recurring contacts.
